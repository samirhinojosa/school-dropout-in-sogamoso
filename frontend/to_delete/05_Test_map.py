...
df = pd.read_csv(os.path.join(os.path.dirname(__file__), "instituciones_2022.csv"))
# df = pd.read_csv("instituciones_2022.csv", sep=",")
st.markdown("<h1 style='text-align: center; color: black;'>Geographical distribution of dropout</h1>", unsafe_allow_html=True)
